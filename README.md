...
**Behavioral analysis throughout.** Each project goes beyond standard metrics to examine *how* behavior unfolds: activation sequences, engagement patterns, disengagement pathways, network positions. This framing, informed by my sociology background, asks why users behave differently, not just whether they do.
